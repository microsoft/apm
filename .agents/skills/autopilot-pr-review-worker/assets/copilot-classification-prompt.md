...
Each autopilot-pr-review-worker iteration fetches the inline review and
...
autopilot-pr-review-worker iteration AND at the top of each new outer
iteration. Hard cap: **2 Copilot rounds per autopilot-pr-review-worker run**.
