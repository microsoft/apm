...
| `manifest_parse` | `1` (always) | error | `Cannot parse apm.yml: <error>` | Fix the YAML syntax error in `apm.yml`. This check is unconditional -- malformed manifests always fail the audit. |
