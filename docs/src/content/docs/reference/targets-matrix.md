...
- **Compile output.** `AGENTS.md`. Supports compilation deduplication: instructions deployed to `.agents/rules/` are omitted from `AGENTS.md` to avoid duplicate context.
