...
If you run the legacy `apm update --check` or `apm update --self`, the
CLI prints a deprecation notice and forwards to `apm self-update`.
Update your scripts to call `apm self-update` directly.
</Aside>
