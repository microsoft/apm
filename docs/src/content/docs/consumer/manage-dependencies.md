...
| Registry shorthand | `owner/repo#^2.0.0` with `registries.default` set | Semver range routes dep through the default registry instead of git. Requires `registries` experimental flag. |
| Registry object form | `{ id: owner/repo, version: ^2.0.0 }` | Explicit registry dep. `registry:` optional when `registries.default` set. Requires `registries` experimental flag. |
