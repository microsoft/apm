...
| Object form (git) | `{ git: <url>, path: <subpath>, ref: <ref>, alias: <name>, type: gitlab }` | Custom directory name (`alias`), nested groups, monorepo subpaths, bespoke GitLab hosts, or anything the string forms cannot express. |
