...
GitHub Copilot | Claude Code | Cursor | OpenCode | Codex | Gemini | Grok Build | Windsurf | Kiro
...
- **[One manifest for everything](https://microsoft.github.io/apm/reference/primitive-types/)** -- declared once, deployed across Copilot, Claude, Cursor, OpenCode, Codex, Gemini, Grok Build, Windsurf, Kiro
