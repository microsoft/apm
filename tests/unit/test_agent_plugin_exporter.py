...
def test_agent_bundle_writes_portable_core_and_valid_docs(tmp_path: Path) -> None:
    ...
    source_asset = project / ".apm" / "skills" / "demo" / "asset.bin"
    source_asset.write_bytes(b"\x00binary\r\npayload\xff")
    ...
    assert (bundle / "skills" / "demo" / "asset.bin").read_bytes() == source_asset.read_bytes()
