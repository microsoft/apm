...
class TestInstallCommandAutoBootstrap:
    ...
    def setup_method(self): None -> None:
    ...
    def teardown_method(self): None -> None:
    ...
    def test_install_no_apm_yml_no_packages_shows_helpful_error(self): None -> None:
    ...
    @patch("apm_cli.commands.install._validate_package_exists")
    def test_install_invalid_package_format_with_no_apm_yml(self, mock_validate): None -> None:
...
class TestValidationFailureReasonMessages:
    ...
    def test_validation_failure_without_verbose_includes_verbose_hint(self, mock_validate): None -> None:
    ...
    @patch("apm_cli.commands.install._validate_package_exists", return_value=False)
    def test_validation_failure_with_verbose_omits_verbose_hint(self, mock_validate): None -> None:
    ...
    def test_verbose_validation_failure_calls_build_error_context(self, mock_urlopen, _mock_cred): None -> None:
    ...
    def test_verbose_virtual_package_validation_shows_auth_diagnostics(self): None -> None:
    ...
    def test_virtual_package_validation_reuses_auth_resolver(self): None -> None:
...
class TestTransitiveDepParentChain:
    ...
    def test_get_ancestor_chain_returns_breadcrumb(self): None -> None:
    ...
    def test_get_ancestor_chain_single_node(self): None -> None:
    ...
    def test_get_ancestor_chain_root_node(self): None -> None:
    ...
    def test_download_callback_includes_chain_in_error(self, tmp_path): None -> None:
        ...
        def tracking_callback(dep_ref, mods_dir, parent_chain=""): None -> None:
...
class TestDownloadCallbackErrorMessages:
    ...
    def test_direct_dep_failure_says_download_dependency(self, tmp_path, monkeypatch): None -> None:
    ...
    def test_transitive_dep_key_not_in_direct_dep_keys(self): None -> None:
...
class TestCallbackFailureDeduplication:
    ...
    def test_callback_failure_not_duplicated_in_main_loop(self, tmp_path, monkeypatch): None -> None:
...
class TestLocalPathValidationMessages:
    ...
    def test_local_path_failure_reason_nonexistent(self, tmp_path): None -> None:
    ...
    def test_local_path_failure_reason_file_not_dir(self, tmp_path): None -> None:
    ...
    def test_local_path_failure_reason_no_markers(self, tmp_path): None -> None:
    ...
    def test_local_path_failure_reason_valid_apm_yml(self, tmp_path): None -> None:
    ...
    def test_local_path_failure_reason_remote_ref(self): None -> None:
    ...
    def test_hint_finds_skill_in_subdirectory(self, tmp_path, capsys): None -> None:
    ...
    def test_hint_finds_nested_skill(self, tmp_path, capsys): None -> None:
    ...
    def test_hint_silent_when_no_packages(self, tmp_path, capsys): None -> None:
    ...
    def test_hint_caps_at_five(self, tmp_path, capsys): None -> None:
...
class TestInstallGlobalFlag:
    ...
    def test_global_flag_shows_scope_info(self): None -> None:
    ...
    def test_global_short_flag_g(self): None -> None:
    ...
    def test_global_without_packages_and_no_manifest_errors(self): None -> None:
    ...
    def test_global_rejects_local_path_package(self): None -> None:
    ...
    def test_global_rejects_absolute_local_path(self): None -> None:
    ...
    def test_global_rejects_tilde_local_path(self): None -> None:
...
class TestGenericHostSshFirstValidation:
    ...
    def _make_completed_process(self, returncode, stderr=""): None -> None:
    ...
    def test_generic_host_tries_ssh_first_and_succeeds(self, mock_run): None -> None:
    ...
    @patch("subprocess.run")
    def test_generic_host_falls_back_to_https_when_ssh_fails(self, mock_run): None -> None:
    ...
    @patch("subprocess.run")
    def test_generic_host_returns_false_when_both_transports_fail(self, mock_run): None -> None:
    ...
    @patch("subprocess.run")
    def test_explicit_http_generic_host_tries_http_first(self, mock_run): None -> None:
    ...
    @patch("subprocess.run")
    def test_github_host_skips_ssh_attempt(self, mock_run): None -> None:
    ...
    @patch("subprocess.run")
    def test_ghes_host_skips_ssh_attempt(self, mock_run): None -> None:
...
class TestExplicitTargetDirCreation:
    ...
    def test_explicit_target_creates_dir_for_auto_create_false(self): None -> None:
    ...
    def test_auto_detect_skips_dir_for_auto_create_false(self): None -> None:
    ...
    def test_auto_create_true_always_creates_dir(self): None -> None:
...
class TestContentHashFallback:
    ...
    def test_hash_match_skips_redownload(self): None -> None:
    ...
    def test_hash_mismatch_triggers_redownload(self): None -> None:
    ...
    def test_missing_content_hash_skips_fallback(self): None -> None:
...
class TestAllowInsecureFlag:
    ...
    def test_http_dep_rejected_without_allow_insecure_flag(self): None -> None:
    ...
    def test_install_help_mentions_allow_insecure_for_http_deps(self): None -> None:
    ...
    def test_allow_insecure_host_rejects_non_hostname(self): None -> None:
    ...
    def test_http_dep_validation_check(self): None -> None:
    ...
    def test_http_dep_passes_with_allow_insecure_flag(self): None -> None:
    ...
    def test_http_dep_without_dep_level_allow_insecure_is_blocked(self): None -> None:
    ...
    def test_https_dep_passes_without_flag(self): None -> None:
    ...
    def test_empty_deps_list_passes(self): None -> None:
...
class TestInsecureDependencyWarnings:
    ...
    def test_collect_insecure_dependency_infos_marks_direct_dependency(self): None -> None:
    ...
    def test_collect_insecure_dependency_infos_marks_transitive_dependency(self): None -> None:
    ...
    def test_format_insecure_dependency_warning_for_transitive_dep(self): None -> None:
...
class TestTransitiveInsecureDependencyGuard:
    ...
    def test_transitive_guard_blocks_unapproved_host(self): None -> None:
    ...
    def test_transitive_guard_allows_same_host_as_direct_insecure_dependency(self): None -> None:
    ...
    def test_transitive_guard_accepts_explicit_host(self): None -> None:
    ...
    def test_transitive_guard_blocks_different_host_without_explicit_allowance(self): None -> None:
...
class TestInstallMcpFlag:
    ...
    @contextlib.contextmanager
    def _chdir_with_apm_yml(self): None -> None:
    ...
    def test_mcp_with_double_dash_collects_stdio_command(self): None -> None:
    ...
    def test_mcp_remote_http(self): None -> None:
        with self._chdir_with_apm_yml() as tmp, \
             patch("apm_cli.commands.install._get_invocation_argv",
    ...
    def test_mcp_env_repeats_collect_into_dict(self): None -> None:
        with self._chdir_with_apm_yml() as tmp, \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "foo",
                                 "--env", "A=1", "--env", "B=2",
    ...
    def test_mcp_header_repeats_collect_into_dict(self): None -> None:
        with self._chdir_with_apm_yml() as tmp, \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "api",
                                 "--url", "https://x/y",
    ...
    def test_e1_mcp_with_positional_packages(self): None -> None:
    ...
    def test_e9_header_without_url(self): None -> None:
        with self._chdir_with_apm_yml(), \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "foo",
                                 "--header", "X-A=1"]):
    ...
    def test_e12_stdio_transport_with_url(self): None -> None:
        with self._chdir_with_apm_yml():
            result = self.runner.invoke(
                cli, ["install", "--mcp", "foo",
    ...
    def test_e13_remote_transport_with_command(self): None -> None:
        with self._chdir_with_apm_yml(), \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "foo",
    ...
    def test_e14_env_with_url(self): None -> None:
        with self._chdir_with_apm_yml(), \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "api",
    ...
    def test_invalid_env_pair_format(self): None -> None:
        with self._chdir_with_apm_yml(), \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "foo",
    ...
    def test_dry_run_does_not_modify_apm_yml(self): None -> None:
        with self._chdir_with_apm_yml() as tmp, \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "foo",
                                 "--dry-run", "--", "npx", "srv"]):
    ...
    def test_invalid_mcp_name_shape(self): None -> None:
        with self._chdir_with_apm_yml(), \
             patch("apm_cli.commands.install._get_invocation_argv",
    ...
    def test_registry_https_url_persisted_to_apm_yml(self): None -> None:
        with self._chdir_with_apm_yml() as tmp, \
             patch("apm_cli.commands.install._get_invocation_argv",
    ...
    def test_registry_http_url_accepted_for_enterprise(self): None -> None:
        with self._chdir_with_apm_yml() as tmp, \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "srv",
    ...
    def test_registry_normalizes_trailing_slash(self): None -> None:
        with self._chdir_with_apm_yml() as tmp, \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "srv",
    ...
    def test_registry_file_scheme_rejected(self): None -> None:
        with self._chdir_with_apm_yml():
            result = self.runner.invoke(
                cli, ["install", "--mcp", "srv",
    ...
    def test_registry_file_with_host_scheme_rejected(self): None -> None:
        with self._chdir_with_apm_yml():
            result = self.runner.invoke(
                cli, ["install", "--mcp", "srv",
    ...
    def test_registry_ws_scheme_rejected(self): None -> None:
        with self._chdir_with_apm_yml():
            result = self.runner.invoke(
                cli, ["install", "--mcp", "srv",
    ...
    def test_registry_javascript_scheme_rejected(self): None -> None:
        with self._chdir_with_apm_yml():
            result = self.runner.invoke(
                cli, ["install", "--mcp", "srv",
    ...
    def test_registry_empty_string_rejected(self): None -> None:
        with self._chdir_with_apm_yml():
            result = self.runner.invoke(
    ...
    def test_registry_schemeless_rejected(self): None -> None:
        with self._chdir_with_apm_yml():
            result = self.runner.invoke(
                cli, ["install", "--mcp", "srv",
    ...
    def test_registry_with_self_defined_url_rejected(self): None -> None:
    ...
    def test_registry_with_stdio_command_rejected(self): None -> None:
    ...
    def test_registry_without_mcp_rejected(self): None -> None:
        with self._chdir_with_apm_yml():
            result = self.runner.invoke(
    ...
    def test_registry_flag_overrides_env_var(self): None -> None:
    ...
    def test_registry_with_version_overlay_persists_both(self): None -> None:
        with self._chdir_with_apm_yml() as tmp, \
             patch("apm_cli.commands.install._get_invocation_argv",
                   return_value=["apm", "install", "--mcp", "srv",
                                 "--mcp-version", "1.2.3",
