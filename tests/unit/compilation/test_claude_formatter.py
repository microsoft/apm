...
""")
        ...
        content = list(result.commands_generated.values())[0]  # noqa: RUF015
...
""")
        ...
        command_names = [p.name for p in result.commands_generated.keys()]  # noqa: SIM118
...
""")
        ...
        result = generate_claude_commands(
            str(temp_project), prompt_files=[prompt_file], dry_run=True
        )
