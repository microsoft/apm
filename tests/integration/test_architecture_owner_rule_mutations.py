...
MUTATIONS: tuple[MutationCase, ...] = (
    ...
    MutationCase(
        guard_id="install-deployment-claude-lsp-plugin",
        rule_id="install-deployment-claude-lsp-plugin",
    ...
    MutationCase(
        ...
        intent="LSP executable trust loses the shared trust-context owner.",
    ),
    MutationCase(
