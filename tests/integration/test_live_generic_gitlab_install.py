...
a stable public APM-shaped GitLab repo. The planned fixture is tracked in
microsoft/apm#1229 and is not public yet. Once published, configure:
...
def _run_install(
    ...
    return subprocess.run(
        ...
        env=isolated_live_subprocess_env(fake_home),
        check=False,
    )
