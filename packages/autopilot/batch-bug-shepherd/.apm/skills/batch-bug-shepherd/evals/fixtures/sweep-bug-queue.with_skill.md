...
autopilot-pr-review-worker, fold-vs-defer classification, pushes, CI watch, and
...
orchestrator-attributable comment per PR; the in-loop autopilot-pr-review-worker
