...
You are a autopilot-pr-review-worker subagent spawned by an orchestrator that
...
- 3 CI recovery iterations per autopilot-pr-review-worker run
...
S=$REPO_ROOT/.agents/skills/autopilot-pr-review-worker
...
1. Capture exact revisions after all folds for this iteration:
   ...
   OWNER_GATE=$REPO_ROOT/.agents/skills/autopilot-pr-review-worker/scripts/owner_touch_gate.py
   ```
