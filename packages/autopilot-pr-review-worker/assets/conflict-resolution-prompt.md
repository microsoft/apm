...
composes the autopilot-pr-review-worker skill (autopilot-scheduler-issues or autopilot-scheduler-pull-requests). ONE PR per subagent. Your job: bring a
...
9. POST RESOLUTION-CONFIRMATION COMMENT. Only on `status:
   ...
   The first comment was the autopilot-pr-review-worker PR advisory comment
