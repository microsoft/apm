...
| `plugin.json` with an Agent Plugins `$schema` | Portable Agent Plugin | Installed whole and registered natively with GitHub Copilot CLI 1.0.81 or newer (floor `1.0.81-8`); other targets and older clients fail closed |
