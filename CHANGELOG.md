...
- `apm deps list`, `apm deps tree`, and `apm prune` no longer treat embedded
  package manifests as independent orphans, while the dependency tree now
  renders every lockfile-resolved depth without a fixed cutoff. (#2092)
