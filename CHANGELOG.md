...
- OpenCode agent install converts list or comma-separated `tools` frontmatter to the object OpenCode requires, instead of copying the rejected shape verbatim. -- by @futbolsalas15 (#1478)
