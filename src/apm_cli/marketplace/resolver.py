...
from ._resolver_match import (
    _dependency_reference_from_packed_source as _dependency_reference_from_packed_source,
)
from ._resolver_match import (
    _extract_auth as _extract_auth,
)
from ._resolver_match import (
    _extract_token as _extract_token,
)
from ._resolver_match import (
