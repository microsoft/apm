...
class PrIntegrator:
    ...
    def open_or_update(
        ...
        **kwargs,
        ...
        Keyword Args:
            no_pr: If ``True``, skip PR creation entirely.
            draft: If ``True``, create the PR as a draft.
            dry_run: If ``True``, do not actually create the PR.
    ...
    def _open_or_update_inner(
        ...
        *,
        ...
        from . import _pr_data

        return _pr_data._open_or_update_inner(self, plan, target, draft=draft, dry_run=dry_run)
