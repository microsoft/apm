"""Public dataclasses for the marketplace builder pipeline.

Extracted from :mod:`class_` to keep that module under 400 lines.
All names continue to be importable from
:mod:`apm_cli.marketplace.builder.class_` via explicit re-exports.
"""
