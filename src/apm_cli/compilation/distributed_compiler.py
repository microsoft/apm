...
AGENTS_MD_GENERATED_MARKER = DISTRIBUTED_AGENTS_MD_GENERATED_MARKER

# Cleanup deliberately differs from ContextOptimizer's placement exclusions:
# cleanup must retain its marker-gated orphan scope while avoiding control trees.
