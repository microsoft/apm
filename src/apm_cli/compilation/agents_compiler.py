...
from ._compiler_helpers import _build_expected_rule_filenames as _build_expected_rule_filenames
...
_VSCODE_TARGET_ALIASES = (
    ...
    *(a for a in _COPILOT_CAPABILITY.aliases if a != _COPILOT_CAPABILITY.compile_family),
)
